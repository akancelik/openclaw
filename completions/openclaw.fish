...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Delivery channel (last|telegram|whatsapp|discord|googlechat|slack|nostr)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Delivery channel (last|telegram|whatsapp|discord|googlechat|slack|nostr)'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (telegram, whatsapp, discord, googlechat, slack, nostr)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (telegram, whatsapp, discord, googlechat, slack, nostr)'
